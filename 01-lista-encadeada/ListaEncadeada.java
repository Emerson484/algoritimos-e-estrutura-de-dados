/* implementar  ListaEncadeada usando as variáveis Head e Tail e não circular.
Criar um método imprimir para imprimir os elementos da lista separados por espaço vazio.
Criar uma classe teste com método main para testes da lista.
Implementar diversos testes com criação de valores para a lista (numeros inteiros).
*/
...
public class ListaEncadeada {
	...
	public final class Element {
		private Object data; //tipo de elemento que vai armazenar
	...
	public void atribuir(ListaEncadeada listaPraCopiar) { // o que ta dentro do parentese sera copiado
	...
	public void extrair(Object itemParaRemover) throws ObjetoNaoEncontradoException  {
