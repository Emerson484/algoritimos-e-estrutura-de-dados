...
public class ListaEncadeadaGenerica <T> {
	...
	public final class Element {
		...
		public String toString() {
			return String.valueOf(data); //converte pra string
	...
	//juntar elementos numa string
	public String toString() {
		StringBuilder minhastring = new StringBuilder();
		Element atual =head;
		
		while(atual != null) {
			minhastring.append(atual.toString()+"");
			atual=atual.next;
		}
		//minhastring.toString(); //como nao atribuiu a nehuma variavel,essa conversao e perdida e o ojecto
		//continua sendo StringBuilder
